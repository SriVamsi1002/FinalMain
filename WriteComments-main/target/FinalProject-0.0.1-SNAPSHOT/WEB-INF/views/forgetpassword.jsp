  ...
  <script>
    ...
    function sendmail() {
    	  ...
    	  $.ajax({
    	    ...
    	    error: function() {
    	      alert("Error occurred at email. Please try again later.");
    	    }
    	  });
    	}
...
function sendotp(email)
    	{
	        ...
	        $.ajax({
	          ...
	          error: function() {
	            alert("Error occurred at  otp stage. Please try again later.");
	          }
	        });
    	}
 ...
 function validateOTP() {
	  ...
	  $.ajax({
	    ...
	    error: function() {
	      alert("Error occurred at verification . Please try again later.");
	    }
	  });
	}
